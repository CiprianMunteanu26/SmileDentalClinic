...
namespace Scheduler.Service.src
{
    public static class Extensions
    {
        ...
        {
            return new AppointmentDto(appointment.Id, appointment.UserId, appointment.Name, appointment.StartTime, appointment.EndTime, appointment.Type, appointment.DoctorId, appointment.Status );
        }
